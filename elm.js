...
Elm.Main.make = function (_elm) {
   ...
   var todoView = function (todo) {
      return A2($Html.li,
      _U.list([$Html$Attributes.classList(_U.list([{ctor: "_Tuple2",_0: "complete",_1: todo.completed}]))]),
      _U.list([A2($Html.div,
   ...
   var NoOp = {ctor: "NoOp"};
   var Model = F3(function (a,b,c) {    return {todos: a,todo: b,filter: c};});
   var Completed = {ctor: "Completed"};
   var Active = {ctor: "Active"};
   var All = {ctor: "All"};
   var initialModel = {todos: _U.list([{title: "The first todo",completed: false,editing: false}])
